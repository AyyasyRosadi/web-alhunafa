...
export default function Footer() {
    ...
    return (
        <div className='md:h-[35vh] bg-base flex md:justify-between md:flex-row flex-col py-5 px-[5%] md:gap-0 gap-5 text-white font-bahij '>
            <div className='md:w-[33%] flex flex-col justify-center md:items-start items-end'>
                <div className='flex flex-col gap-4 items-end w-[60%]'>
